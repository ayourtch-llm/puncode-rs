...
use puncode_security::config::{default_codex_config, scan_model_configuration};
...
const NEXT_STEP: &str = "puncode-security scan . --dry-run";
...
fn render_text(report: &Value) -> String {
    ...
    [
        format!("puncode-security {}", field("cliVersion")),
        String::new(),
