...
use puncode_security::config::{PuncodeSecurityConfig, merged_codex_config};
use puncode_security::model_endpoint::{
...
fn survives_the_merge_into_the_real_configuration() {
    ...
    let merged = merged_codex_config(&PuncodeSecurityConfig {
