...
use puncode_security::models::{CoverageDocument, FindingsDocument, ScanManifest};
use puncode_security::result::{ScanResult, ScanResultOptions, TurnResultMetadata};
use serde_json::json;
...
fn reports_the_plugin_version_from_the_manifest() {
    ...
    assert_ne!(
        ...
        puncode_security::BUNDLED_PLUGIN_VERSION,
