...
impl ComparisonAgent for FakeAgent {
    fn compare(&self, prompt: &str, _: &ScanComparisonOptions) -> puncode_security::Result<String> {
...
fn compare_one(response: &Value) -> puncode_security::Result<ScanComparisonResult> {
    match_scan_findings(
...
fn runs_a_locked_down_turn_against_the_real_executable() {
    use puncode_security::scan_comparison::ProcessComparisonAgent;
