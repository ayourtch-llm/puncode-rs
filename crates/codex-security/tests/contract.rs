...
use codex_security::contract::{LoadContractOptions, load_contract, require_scan_file};
...
fn load(scan: &Path) -> codex_security::Result<codex_security::LoadedContract> {
...
fn loads_the_unchanged_plugin_example() {
    ...
    assert_eq!(
        ...
        codex_security::SeverityLevel::High
    );
