...
#[non_exhaustive]
pub enum ErrorKind {
    /// The base `CodexSecurityError`, thrown directly upstream.
    CodexSecurity,
    Configuration,
...
impl Error {
    ...
    #[must_use]
    pub fn codex_security(message: impl Into<String>) -> Self {
        Self::new(ErrorKind::CodexSecurity, message)
    }
    ...
    pub fn class_name(&self) -> &'static str {
        match *self.kind {
            ErrorKind::CodexSecurity => "CodexSecurityError",
